...
@Autonomous
public  class AtonCenterRed  extends LinearOpMode
{
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive()) {
                ...
                if (SkystoneDeterminationPipeline.hi==1){
                    ...
                    Degree_Turn(127,0.33,"Left");
                    Encoder_Move(5 , 0.33, "Left");
                    ...
                    Encoder_Move(17,0.33,"Left");
                    Encoder_Move(75,0.6,"Forward");

                    Encoder_Move(12,0.33,"Right");
                ...
                if (SkystoneDeterminationPipeline.hi==2){
                    ...
                    Encoder_Move(28, 0.33, "Forward");//move 2in back
                    PurplePixel.setPosition(0.65);
                    sleep(1000);
                    PurplePixel.setPosition(0.04);
                    Encoder_Move(24, 0.33, "Backward");
                    Degree_Turn(130,0.33,"Left");
                    Encoder_Move(75,0.33,"Forward");

                    Encoder_Move(20,0.33,"Right");
                ...
                if (SkystoneDeterminationPipeline.hi==3){
                    ...
                    Encoder_Move(13,0.33,"Backward");
                    Degree_Turn(128,0.33,"Left");
                    Encoder_Move(65,0.4,"Forward");
