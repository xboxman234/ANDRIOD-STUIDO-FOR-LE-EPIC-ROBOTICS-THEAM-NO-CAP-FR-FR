...
@Autonomous
public  class ATongBlue_2023_2024  extends LinearOpMode
{
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive()) {
                ...
                if (SkystoneDeterminationPipeline.hi==1){
                    Encoder_Move(17, 0.33, "Forward");//move 2in back
                    Encoder_Move(22,0.33,"Left");
                    //Encoder_Move(3 , 0.33, "Left");
                    PurplePixel.setPosition(0.65);
                    sleep(1000);
                    PurplePixel.setPosition(0.06);

                    Degree_Turn(3,0.33,"Left");
                    Encoder_Move(15,0.33,"Backward");
                    Encoder_Move(92,0.33,"Right");
                    Encoder_Move(43,0.50,"Forward");
                    Degree_Turn(130,0.33,"Right");
                    //Encoder_Move(9,0.33,"Right");
                    Encoder_Move(27,0.33,"Forward");
                ...
                if (SkystoneDeterminationPipeline.hi==2){
                    ...
                    Encoder_Move(24, 0.33, "Forward");//move 2in back
                    Encoder_Move(4, 0.33, "Left");//move 2in back

                    //Encoder_Move(2, 0.33, "Right");
                    PurplePixel.setPosition(0.65);
                    sleep(1000);
                    PurplePixel.setPosition(0.04);
                    Encoder_Move(20, 0.33, "Backward");
                    Degree_Turn(133,0.33,"Right");
                    Encoder_Move(75,0.33,"Forward");

                    Encoder_Move(38 ,0.33,"Left");
                ...
                if (SkystoneDeterminationPipeline.hi==3){
                    Encoder_Move(3, 0.33, "Left");
                    Encoder_Move(22, 0.33, "Forward");//move 2in back
                    Degree_Turn(130,0.33,"Right");
                    Encoder_Move(16,0.33,"Left");
                    //Encoder_Move(3 , 0.33, "Left");
                    PurplePixel.setPosition(0.65);
                    sleep(1000);
                    PurplePixel.setPosition(0.06);
                    ...
                    Encoder_Move(36,0.33,"Right");
                    Encoder_Move(80,0.6,"Forward");

                    Encoder_Move(25,0.33,"Left");
                    Encoder_Move(15,0.5,"Forward");
                    //Degree_Turn(135,0.33,"Left");
                    //Encoder_Move(18,0.33,"Forward");
